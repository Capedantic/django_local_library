...
from django.contrib.auth.models import User, Permission #Requireed to assign User as a borrower
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        #Create two users
        test_user1 = User.objects.create_user(username='testuser1', password='123')
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        permission = Permission.objects.get(name='View books on loan')
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password='123')
    ...
    def test_redirects_to_all_borrowed_books_on_success(self):
        login = self.client.login(username='testuser2', password='123')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_librarian_does_have_access(self):
        login = self.client.login(username='testuser2', password='123')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
